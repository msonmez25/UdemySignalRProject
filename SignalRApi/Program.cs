...
builder.Services.AddScoped<IOpenInfoService, OpenInfoManager>();
builder.Services.AddScoped<IOpenInfoDal, EfOpenInfoDal>();
...
builder.Services.AddScoped<ISliderService, ISliderManager>();
